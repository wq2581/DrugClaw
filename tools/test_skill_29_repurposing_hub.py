...
def main() -> int:
    ...
    if problems:
        fixes.append("Keep RepurposingHubSkill aligned with the local-file contract used by tools/test_skill_29_repurposing_hub.py.")

    print(json.dumps(asdict(Report(
        status=status,
        commands_executed=["python tools/test_skill_29_repurposing_hub.py"],
