...
def run_case(case: SkillCase) -> SkillReport:
    commands = ["python tools/test_skills_40_49.py"]
    checks = [
    ...
    if problems:
        fixes.append("Align the runtime skill behavior with the grouped smoke-test contract in tools/test_skills_40_49.py.")
