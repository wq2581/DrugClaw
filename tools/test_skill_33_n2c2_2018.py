...
def main() -> int:
    ...
    fixes = [] if not problems else ["Keep N2C22018Skill aligned with the local-file contract used by tools/test_skill_33_n2c2_2018.py."]
    print(json.dumps(asdict(Report(status, ["python tools/test_skill_33_n2c2_2018.py"], checks, sample, problems, fixes)), indent=2, ensure_ascii=False))
