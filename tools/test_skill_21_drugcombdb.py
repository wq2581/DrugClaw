...
def main() -> int:
    ...
    if problems:
        fixes.append("Keep DrugCombDBSkill aligned with the local-file contract used by tools/test_skill_21_drugcombdb.py.")

    print(json.dumps(asdict(Report(
        status=status,
        commands_executed=["python tools/test_skill_21_drugcombdb.py"],
