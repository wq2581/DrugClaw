...
def main() -> int:
    ...
    if problems:
        fixes.append("Keep UniToxSkill aligned with the local-file contract used by tools/test_skill_28_unitox.py.")

    print(json.dumps(asdict(Report(
        status=status,
        commands_executed=["python tools/test_skill_28_unitox.py"],
