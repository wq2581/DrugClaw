...
**Purpose**: Pharmacology reference  

**Coverage**: Expert-curated targets, drugs, and pharmacological data  

## Usage

```python
from drugclaw.skills.drug_knowledgebase.iuphar import IUPHARSkill

skill = IUPHARSkill(config={
})
