...
**Purpose**: Drug information resource  

**Coverage**: FDA-approved drug information, indications, targets  

## Usage

```python
from drugclaw.skills.drug_knowledgebase.drugcentral import DrugCentralSkill

skill = DrugCentralSkill(config={
})
