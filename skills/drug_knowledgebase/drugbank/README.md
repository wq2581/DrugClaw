...
**Purpose**: Comprehensive drug reference  

**Coverage**: Drug structures, pharmacology, targets, interactions  

## Usage

```python
from drugclaw.skills.drug_knowledgebase.drugbank import DrugBankSkill

skill = DrugBankSkill(config={
})
