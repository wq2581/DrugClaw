#!/usr/bin/env python3
"""
Fixed retrieval CLI for DrugBank.
Usage: python retrieve.py entity1 [entity2 ...]
Entities: drug names or DrugBank IDs (DB#####)
"""
import sys
import os
...
from example import load, search_batch, summarize
...
def main():
    ...
    try:
        ...
        print(f"[DrugBank] Error: {exc}", file=sys.stderr)
        sys.exit(1)
