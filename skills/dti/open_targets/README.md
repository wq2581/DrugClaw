...
**Purpose**: Drug-target evidence  

**Coverage**: Curated + ML drug-target evidence scores  

## Usage

```python
from drugclaw.skills.dti.open_targets import OpenTargetsSkill

skill = OpenTargetsSkill(config={
})
