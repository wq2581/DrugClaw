...
**Purpose**: Drug–protein interactions  

**Coverage**: Chemical–protein interaction network (STRING extension)  

## Usage

```python
from drugclaw.skills.dti.stitch import STITCHSkill

skill = STITCHSkill(config={
})
