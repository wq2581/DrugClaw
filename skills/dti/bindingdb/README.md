...
**Purpose**: Binding affinity data  

**Coverage**: Experimentally measured binding constants (Ki, Kd, IC50)  

## Usage

```python
from drugclaw.skills.dti.bindingdb import BindingDBSkill

skill = BindingDBSkill(config={
})
