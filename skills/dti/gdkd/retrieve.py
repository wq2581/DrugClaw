#!/usr/bin/env python3
"""
Fixed retrieval CLI for GDKD (Gene-Drug-Kinase Database).
Usage: python retrieve.py entity1 [entity2 ...]
Entities: drug names or kinase/gene names
"""
import sys
import os
...
from example import load_gdkd, search_batch, summarize
...
def main():
    ...
    try:
        ...
        print(f"[GDKD] Error: {exc}", file=sys.stderr)
        sys.exit(1)
