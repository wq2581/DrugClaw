#!/usr/bin/env python3
"""
Fixed retrieval CLI for ATC (Anatomical Therapeutic Chemical Classification).
Usage: python retrieve.py entity1 [entity2 ...]
Entities: drug names or ATC codes (e.g. A10BA02)
"""
import sys
import os
...
def main():
    ...
    try:
        ...
        print(f"[ATC] Error: {exc}", file=sys.stderr)
        sys.exit(1)
