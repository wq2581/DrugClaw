#!/usr/bin/env python3
"""
Fixed retrieval CLI for ChEBI (Chemical Entities of Biological Interest).
Usage: python retrieve.py entity1 [entity2 ...]
Entities: chemical names or ChEBI IDs (e.g. CHEBI:15365)
"""
import sys
import os
...
def main():
    ...
    try:
        ...
        print(f"[ChEBI] Error: {exc}", file=sys.stderr)
        sys.exit(1)
