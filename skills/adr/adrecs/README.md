...
**Purpose**: ADR classification system  

**Coverage**: Hierarchical adverse drug reaction classification  

## Usage

```python
from drugclaw.skills.adr.adrecs import ADReCSSkill

skill = ADReCSSkill(config={
})
...
- Homepage: <http://bioinf.xmu.edu.cn/ADReCS/>
