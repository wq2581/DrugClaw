...
**Purpose**: FDA drug label search  

**Coverage**: Structured FDA drug labels (adverse events, dosing, warnings)  

## Usage

```python
from drugclaw.skills.drug_labeling.openfda import OpenFDASkill

skill = OpenFDASkill(config={
})
