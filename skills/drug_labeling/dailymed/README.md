...
**Purpose**: Official drug labels (NIH)  

**Coverage**: FDA-approved drug labeling from NIH DailyMed  

## Usage

```python
from drugclaw.skills.drug_labeling.dailymed import DailyMedSkill

skill = DailyMedSkill(config={
})
