...
> **Subcategory**: `drug_disease` &nbsp;|&nbsp; **Access mode**: `Local File`

**Purpose**: Semantic drug-disease KG  

**Coverage**: Drug-disease KG built from semantic types in biomedical literature  
...
|-----|--------------------|
| `csv_path` | path to SemaTyP triplet CSV/TSV file |
| `delimiter` | column delimiter (default: auto-detect from extension) |

## Usage

```python
from drugclaw.skills.drug_disease.sematyp import SemaTyPSkill

skill = SemaTyPSkill(config={
    "csv_path": "...",  # path to SemaTyP triplet CSV/TSV file
    "delimiter": "...",  # column delimiter (default: auto-detect from extension)
})
